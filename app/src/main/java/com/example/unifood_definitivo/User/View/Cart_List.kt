...
import com.example.unifood_definitivo.User.Adapter.CartAdapter
import com.example.unifood_definitivo.User.Adapter.OrariAdapter
 ...
 private fun fetchOrariData() {
  ...
  database.addValueEventListener(object : ValueEventListener {
   override fun onDataChange(snapshot: DataSnapshot) {
    ...
    orariAdapter.updateData(orariList)
   }
